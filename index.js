...
// It can access the variable internal because a function can access to the outside but not inside.
...
const zooAnimals = [
  ...
  */
  ...
  let lowerCaseNames = zooAnimals.map(function(animal){
  ...
  */
  ...
  function lowPopulationAnimals(){
    let lowPopulationAnimals = zooAnimals.filter(function(animal){
  ...
  */
  ...
  function USApop(){
    let totalPop = zooAnimals.reduce(function(counter, animal){
